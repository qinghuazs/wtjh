"""Doubao Seedream 4.5 group output node (text to multi images)."""
...
class WyjhDoubaoSeedream45GroupOutput(BaseWyjhNode):
    ...
    def generate(
        ...
        with time_block("WYJH Doubao Seedream 4.5 Group Output"):
            ...
            print("[WYJH] Doubao Seedream 4.5 Group Output payload:", payload)
            response = self.call("/v1/images/generations", payload)
            print("[WYJH] Doubao Seedream 4.5 Group Output response:", response)
